...
class PendingGameTest {
    ...
    fun setUp() {
        ...
        computer = mock(ComputerPlayer::class.java)
    ...
    fun gameHasAMaximumOf6Players() {
        for (i in 0..4) {
            game!!.addPlayer(mock(Player::class.java))
        }
        try {
            game!!.addPlayer(mock(Player::class.java))
    ...
    fun assignsIdToNewPlayers() {
        ...
        val p1 = mock(Player::class.java)
        val p2 = mock(Player::class.java)
        val p3 = mock(Player::class.java)
